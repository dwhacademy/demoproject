...
DECLARE V_TARG_TBL_NM VARCHAR(255) := 'm007_party_loc_rltd';
...
LEFT JOIN
    ...
    ON md5_hash(t007.party_id) = md5_hash(v_007.party_id)
    AND md5_hash(t007.loc_id) = md5_hash(v_007.loc_id)
    AND md5_hash(t007.rel_cd) = md5_hash(v_007.rel_cd)

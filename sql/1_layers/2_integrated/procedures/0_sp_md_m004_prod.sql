...
INSERT INTO dev_demo_ml.log VALUES(V_LOAD_ID, CURRENT_TIMESTAMP, 'dev_demo_il', 'sp_md_m004_prod', 'm004_prod','delete', V_UPD_CNT);
insert into
...
********************************************/
GET DIAGNOSTICS V_UPD_CNT = ROW_COUNT;
INSERT INTO dev_demo_ml.log VALUES(V_LOAD_ID, CURRENT_TIMESTAMP, 'dev_demo_il', 'sp_md_m004_prod', 'm004_prod','insert', V_UPD_CNT);
END
$$;

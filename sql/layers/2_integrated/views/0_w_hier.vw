CREATE OR REPLACE RECURSIVE VIEW demo_il.w_hier(hier_item_id, hier_item_nm, lvl, hier_cd, parent_hier_item_id, prod_id) AS (
  SELECT
  ...
  FROM
    ...
    INNER JOIN
        demo_il.m003_hier_item_rltd m003_c
        ON m001.hier_item_id = m003_c.child_hier_item_id
    INNER JOIN
        demo_il.m005_hier_item_prod_rltd m005
